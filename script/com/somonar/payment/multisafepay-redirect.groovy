...
logPrefix = "in " + systemResourceId + "-redirect.groovy: "

public class MultiSafepayRedirect {
	public static final String module = MultisafePayRedirect.class.getName();
	 ...
	 * @throws IOException */
	public static String multisafepayredirect(HttpServletRequest request, HttpServletResponse response) throws IOException {
	...
	Debug.logInfo("paramMap is: " + paramMap,module);
	Debug.logInfo("locale is: " + locale,module);
...
request.setAttribute("_ERROR_MESSAGE_", UtilProperties.getMessage(resourceErr, "MultisafePayEvents.PaymentTransactionProcessed", locale));

//set the returned transactionid to the orderId
orderId = parameters.transactionid
request.setAttribute("orderId", orderId);

//include actions to process the order regarding the payment, e.g. status change, record payment transaction, etc.
